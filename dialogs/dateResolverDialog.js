...
class DateResolverDialog extends CancelAndHelpDialog {
    constructor(id, promptText = null) {
        super(id || 'dateResolverDialog', promptText || null);
    ...
    async initialStep(stepContext) {
        ...
        const promptMsg = this.promptText || 'On what date would you like to travel?';
        const repromptMsg = "I'm sorry, for best results, please enter your date including the month, day and year.";
    ...
    async finalStep(stepContext) {
        const value = stepContext.result[1].value;
        return await stepContext.endDialog(value);
    }
    ...
    async dateTimePromptValidator(promptContext) {
        if (promptContext.recognized.succeeded) {
            ...
            let dateOptions = promptContext.recognized.value;
